...
// v2.1: fixed abstract-method issue by giving ExprNode a default kind() implementation.
// Includes: smarter layout, superscripts, fraction centering, parentheses rules,
...
abstract class ExprNode {
  ...
  // Default implementation so subclasses don't have to override.
...
class PlaceholderNode extends ExprNode {
  ...
  @Override int precedence(){ return 100; } // treat like atom for parens
}
